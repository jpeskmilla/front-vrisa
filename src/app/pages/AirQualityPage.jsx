...
export default function AirQualityPage() {
  ...
  const [filters, setFilters] = useState({
    ...
    start_date: new Date(new Date().setDate(new Date().getDate() - 7)).toISOString().split('T')[0], // Última semana
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <ResponsiveContainer width="100%" height={350}>
                    <AreaChart data={data} margin={{ top: 10, right: 30, left: 0, bottom: 0 }}>
                        ...
                        <Area 
                            ...
                            fillOpacity={1} 
                            fill="url(#colorValue)" 
                            name={`${filters.variable_code} (${currentUnit})`}
                        />
                    </AreaChart>
                </ResponsiveContainer>
            </div>
            ...
            <div className="space-y-4">
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                    ...
                    <p className="text-3xl font-bold text-gray-800 mt-2">{stats.avg} <span className="text-sm font-normal text-gray-500">{currentUnit}</span></p>
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                    ...
                    <p className="text-3xl font-bold text-gray-800 mt-2">{stats.max} <span className="text-sm font-normal text-gray-500">{currentUnit}</span></p>
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                    ...
                    <p className="text-3xl font-bold text-gray-800 mt-2">{stats.min} <span className="text-sm font-normal text-gray-500">{currentUnit}</span></p>
                </div>
            </div>
        </div>
      ) : (
